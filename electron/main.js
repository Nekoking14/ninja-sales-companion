...
function createLauncher (serverOk) {
  ...
  const html = `<!DOCTYPE html><html><head><meta charset="utf-8"><style>
    *{margin:0;padding:0;box-sizing:border-box;}
    body{background:#08091A;color:#E2E8F5;font-family:system-ui,-apple-system,sans-serif;
    ...
    <div class="btns">
      <button class="open" onclick="open()">Open in browser</button>
      <button class="quit" onclick="quit()">Quit</button>
    </div>
    <script>
      const {ipcRenderer} = require('electron')
      function open() { ipcRenderer.send('open-app') }
